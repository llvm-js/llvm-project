const { ExpressionException } = require("../../exceptions/src");
        ...
        switch (char) {
            ...
            default:
                if (this._matchInt(char)) this.addTokenType(EXPRESSION_TOKEN_TYPE.NUMBER);
                    ...
                    console.log('Letters and symbols that are not related to mathematics are prohibited in a mathematical expression.', 'Possible fixes');
                    process.exit(1);
                }
                break;
        }
